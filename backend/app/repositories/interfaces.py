...
class IRuleRepository(ABC):
    ...
    @abstractmethod
    async def list_statutory_documents(self, doc_type: Optional[str] = None, status: Optional[str] = None, family: Optional[str] = None, search: Optional[str] = None) -> List[Dict[str, Any]]: ...
    @abstractmethod
    async def get_statutory_document_by_id(self, doc_id: str) -> Optional[Dict[str, Any]]: ...
    @abstractmethod
    async def list_statutory_rules(self, document_id: Optional[str] = None, family: Optional[str] = None, status: Optional[str] = None, search: Optional[str] = None, rule_code: Optional[str] = None) -> List[Dict[str, Any]]: ...
    @abstractmethod
